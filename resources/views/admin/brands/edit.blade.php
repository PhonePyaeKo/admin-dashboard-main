                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-3">
                        <div class="text-base/7 font-semibold text-gray-900">
                            {{ trans('global.edit') }} {{ __('labels.brand.title_singular') }}
                        </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name"
                                        value="{{ old('name', $brand->name) }}" autocomplete="given-name" required
...
@section('scripts')
    <script>
        ...
        Dropzone.options.brandImageDropzone = {
            ...
            init: function() {
                @if (isset($brand) && $brand->getMedia('brand_image')->count())
                    @php
                        $brandImages = $brand->getMedia('brand_image');
                    @endphp
                    @if ($brandImages->count() > 1)
                        @foreach ($brandImages as $media)
